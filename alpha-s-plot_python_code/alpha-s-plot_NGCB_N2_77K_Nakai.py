...
dfs = pd.read_csv("./convert_PP0_to_alpha-s/carbon/Non-Graphitized_carbon_black_sample_NGCB_N2_77K_convert_data.txt", header = 0)
#print(dfs.iloc[:,0])
#print(dfs.iloc[:,1])
...
fig.savefig('./plot/alpha-s-plot_NGCB_std.jpg')
...
dft.T.to_csv("./plot/alpha-s-plot_NGCB_std_results.csv")