...
#
as_coeff = 5.88/3.173 # = 1.853136
as_to_t_coeff = 0.594499587/1.0*ttimes
gas_limit = 0.336*ttimes
read_csv_file_name = "./convert_PP0_to_alpha-s/carbon_additional_data/Carbopack_F_Ar_77K_convert_data.txt"
num_of_t_line = 3
# ***************************************
